# Compile and run probe/p10_felt_hard.cs, with the compiler that is already inside
# Windows. No SDK, no NuGet, no network.
#
# WHY THIS WRAPPER EXISTS. p10_felt_hard.cs produced numbers that are now quoted as
...
#
# What it answers: what a background job costs a foreground one, honestly.
#
...
$src = Join-Path $here "p10_felt_hard.cs"
