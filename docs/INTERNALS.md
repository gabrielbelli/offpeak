...
Everything the [README](../README.md) leaves out: how the machine decides
somebody is using it, what it gives up and when, and what it costs to have
installed.

Every number here was measured on one desktop rather than read off a
documentation page:
...
[docs/ROADMAP.md](ROADMAP.md): a central server, capability self-testing,
